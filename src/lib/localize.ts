...
export function localizeForumCategory<T extends LocalizableForumCategory>(
  item: T,
  locale: string,
): T {
...
export function localizeForumTopic<T extends LocalizableForumTopic>(
  item: T,
  locale: string,
): T {
